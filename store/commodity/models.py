...
class CommodityInfo(models.Model):
    Name = models.CharField('商品名称', max_length=100,default='')
    Info = models.CharField('商品描述信息', max_length=200)
    Material = models.CharField('商品原材料', max_length=100,default='')
    Price = models.DecimalField('商品价格', max_digits=5, decimal_places=2,default=0.0)
    Size = models.DecimalField('商品尺寸', max_digits=2, decimal_places=1,default=0.0)
